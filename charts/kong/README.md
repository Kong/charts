...
| rbac.enableClusterRoles                    | Create ClusterRoles and ClusterRoleBindings required for watching cluster roles. Set it to `false` and add at least one namespace in `watchNamespaces` to disable creating of ClusterRoles and ClusterRoleBindings. | true                                 |
